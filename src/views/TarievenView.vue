...
const packages = computed(() => [
  {
    ...
    features: [t('pkg.f4uur'), t('pkg.f100foto'), t('pkg.fSocial'), t('pkg.f48uurFotoAftermovie'), t('pkg.fGalerij')],
  ...
  },
  {
    ...
    features: [t('pkg.f8uur'), t('pkg.f150foto'), t('pkg.fSocial'), t('pkg.fInterviews'), t('pkg.fDeliverySplit'), t('pkg.fGalerij')],
